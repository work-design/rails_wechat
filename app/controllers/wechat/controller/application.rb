...
module Wechat
  module Controller::Application
    ...
    def current_payee
      ...
      if params[:appid]
        @current_payee = current_organ_domain.payee_apps.enabled.find_by(appid: params[:appid])
      elsif current_wechat_app
        @current_payee = current_organ_domain.payee_apps.enabled.find_by(appid: current_wechat_app.appid)
      else
        @current_payee = current_organ_domain.payee_apps.take
      end
