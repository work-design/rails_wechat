  ...
  module Controller::Application
    ...
    def require_user
      if request.variant.include?(:work_wechat)
        ...
        render 'require_program_login', layout: 'raw', locals: { url: url_for(state: urlsafe_encode64(destroyable: false)) } and return
    ...
    def current_oauth_app
      ...
      if request.variant.include?(:work_wechat)
        @current_oauth_app = Agent.default_where(default_ancestors_params).take || current_organ.corps.take
      else
