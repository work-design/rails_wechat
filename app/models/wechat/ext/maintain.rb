module Wechat
  module Ext::Maintain
    ...
    included do
      ...
      has_many :pending_wechat_users, class_name: 'Wechat::WechatUser', through: :pending_external_users, source: :wechat_user
      has_many :pending_users, class_name: 'Auth::User', through: :pending_wechat_users, source: :user
