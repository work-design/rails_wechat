module Wechat
  module Model::Request
    ...
    def reply_for_blank_info
      ...
      if agency
        url = app.oauth2_url(host: agency.platform.domain, state: agency.base64_state(uid: open_id))
      else
    ...
    def reply_for_user
      if wechat_user.account
        reply_params(
          ...
          url: Rails.application.routes.url_for(controller: 'my/home', host: app.domain, disposable_token: wechat_user.auth_token)
        )
      else
