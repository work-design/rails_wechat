module Wechat
  module Model::CorpUser
    ...
    included do
      ...
      has_many :authorized_tokens, ->(o) { where(suite_id: o.suite_id) }, class_name: 'Auth::AuthorizedToken', primary_key: :open_userid, foreign_key: :corp_userid, dependent: :nullify
